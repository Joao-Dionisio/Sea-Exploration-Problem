...
initially_known = Probings.fromgrid(4, seabed1)
...
# Select estimator (kernel+params).
estimator = Estimator.fromoptimization(initially_known, testing_points, seed, verbose=True)
