...
class ReconfiguredPlotter:
    ...
    def __lshift__(self, other):
        return self.plotter.__lshift__(
            other, self.name, self.xlim, self.ylim, self.zlim, self.inplace, self.block, self.delay, self.color
        )
    ...
    def __call__(self, name=None, xlim=None, ylim=None, zlim=None, inplace=None, block=None, delay=None, color=None):
        ...
        return ReconfiguredPlotter(self.plotter, name, xlim, ylim, zlim, inplace, block, delay, color)
